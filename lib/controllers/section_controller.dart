...
class SectionController {
  ...
  Future<Response> _getAllSections(Request request) async {
    try {
      ...
      var results = await _db.query('SELECT * FROM sections ORDER BY id');
      print('Fetched ${results.length} sections.');
      if (results.isEmpty) {
        return _jsonErrorResponse(404, 'No sections found.');
      }
      // Convert the results to a list of Section models
      // Assuming Section model uses json_serializable for serialization
